...
map.getView().fit([-20013698.618135, -201145910.580520, 20037127.566548, 201145910.580520], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Worldwide Ownership of Physical and Digital Gold</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (236 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Bivariate web-map showing official gold holdings (tonnes) and cryptocurrency ownership rates by country.<br /><br />Sources:<br />2023 crypto data from Triple-A and September 2024 gold holdings from the World Gold Council (WGC).<br /><br />Author: @olitojimenez';
            }
